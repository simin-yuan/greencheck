...
from mdt import audit_gate, audit_gate_counts, audit_ledger, get_path, load_jsonl, __version__  # noqa: E402
from mdt.report import render_markdown  # noqa: E402
...
def main() -> int:
    ...
    lines.append("")
    lines.append(f"Generated by `case_study/run_case_study.py` (mdt {__version__}).")
    lines.append("")
    lines.append("## Data")
    lines.append("")
